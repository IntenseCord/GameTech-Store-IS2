Feature: Modelos de base de datos
  ...
  Scenario: Crear usuario exitosamente
    ...
    Y la contraseña no debería ser válida para "WrongPassword"
  ...
  Scenario: Crear juego exitosamente
    ...
    And el precio debería ser 49.99
    Y el stock debería ser 10
